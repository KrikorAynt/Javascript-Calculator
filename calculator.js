...
function numberSelect(num){
    if(opp){
        if(num2 && num2!='0')
            ...
            num2=num;
        document.getElementById("outputCalc").innerHTML = num1+opp+num2;
    }
    else{
        if(num1 && num1!='0' && num1!=output)
            ...
            num1=num;
        document.getElementById("outputCalc").innerHTML = num1;
    }
...
function oppSelect(opps){
    opp = opps 
    if(num1)
        document.getElementById("outputCalc").innerHTML = num1+opp;
    if(num2)
        document.getElementById("outputCalc").innerHTML +=num2;
    document.getElementById('screen').scrollLeft = document.getElementById('screen').scrollWidth;
...
function clearAll(){
    ...
    num2='';
    opp = '';
    document.getElementById("outputCalc").innerHTML = "0";
}
function clears(){
    if(opp){
        num2='';
